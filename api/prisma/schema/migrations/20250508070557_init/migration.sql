...
-- CreateEnum
CREATE TYPE "UnitType" AS ENUM ('GB', 'TB', 'Hz', 'MP', 'mAh', 'mm');
...
CREATE TABLE "ProductAttributeValue" (
    ...
    CONSTRAINT "ProductAttributeValue_pkey" PRIMARY KEY ("attributeId","productId","order")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductAttributeValue_productId_attributeId_order_key" ON "ProductAttributeValue"("productId", "attributeId", "order");
...
-- CreateIndex
CREATE UNIQUE INDEX "Unit_type_key" ON "Unit"("type");

-- CreateIndex
CREATE UNIQUE INDEX "Unit_uk_ua_key" ON "Unit"("uk_ua");
...
-- AddForeignKey
ALTER TABLE "Attribute" ADD CONSTRAINT "Attribute_unitId_fkey" FOREIGN KEY ("unitId") REFERENCES "Unit"("id") ON DELETE SET NULL ON UPDATE CASCADE;
